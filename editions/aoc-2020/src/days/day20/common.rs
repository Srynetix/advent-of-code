...
/// Puzzle.
pub struct Puzzle(pub Vec<Vec<char>>);
...
impl TileMatcher {
    ...
    ///
    /// * `puzzle` - Puzzle
    pub fn find_and_replace_sea_monsters(puzzle: &Puzzle) -> Option<Puzzle> {
...
mod tests {
    ...
    const MULTIPLE_SAMPLE: &str = indoc! {"
        Tile 2311:
        ..##.#..#.
        ##..#.....
        #...##..#.
