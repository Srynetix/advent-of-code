//! # --- Day 3: Gear Ratios ---
//!
//! > _Exercise page: <https://adventofcode.com/2023/day/3>_
//!
//! > _Input page: <https://adventofcode.com/2023/day/3/input>_
//!
//! You and the Elf eventually reach a <a target="_blank" href="https://en.wikipedia.org/wiki/Gondola_lift">gondola lift</a> station; he says the gondola lift will take you up to the <em>water source</em>, but this is as far as he can bring you. You go inside.
//!
