//! # --- Day 7: Camel Cards ---
//!
//! > _Exercise page: <https://adventofcode.com/2023/day/7>_
//!
//! > _Input page: <https://adventofcode.com/2023/day/7/input>_
//!
//! Your all-expenses-paid trip turns out to be a one-way, five-minute ride in an <a href="https://en.wikipedia.org/wiki/Airship" target="_blank">airship</a>. (At least it's a <span title="Please only read this sentence while listening to 'The Airship Blackjack' from the Final Fantasy 6 soundtrack."><em>cool</em> airship</span>!) It drops you off at the edge of a vast desert and descends back to Island Island.
//!
...
//!
//! Because the journey will take a few days, she offers to teach you the game of <em>Camel Cards</em>. Camel Cards is sort of similar to <a target="_blank" href="https://en.wikipedia.org/wiki/List_of_poker_hands">poker</a> except it's designed to be easier to play while riding a camel.
//!
