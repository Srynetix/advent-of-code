...
//!
//! > _Exercise page: <https://adventofcode.com/2021/day/16>_
//!
//! > _Input page: <https://adventofcode.com/2021/day/16/input>_
//!
//! As you leave the cave and reach open waters, you receive a transmission from the Elves back on the ship.
//!
//! The transmission was sent using the Buoyancy Interchange Transmission System (<span title="Just be glad it wasn't sent using the BuoyancY Transmission Encoding System.">BITS</span>), a method of packing numeric expressions into a binary sequence. Your submarine's computer has saved the transmission in <a target="_blank" href="https://en.wikipedia.org/wiki/Hexadecimal">hexadecimal</a> (your puzzle input).
//!
