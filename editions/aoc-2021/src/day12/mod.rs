...
//!
//! > _Exercise page: <https://adventofcode.com/2021/day/12>_
//!
//! > _Input page: <https://adventofcode.com/2021/day/12/input>_
//!
//! With your <span title="Sublime.">submarine's subterranean subsystems subsisting suboptimally</span>, the only way you're getting out of this cave anytime soon is by finding a path yourself. Not just <em>a</em> path - the only way to know if you've found the <em>best</em> path is to find <em>all</em> of them.
//!
