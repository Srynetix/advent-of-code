...
//!
//! > _Exercise page: <https://adventofcode.com/2021/day/11>_
//!
//! > _Input page: <https://adventofcode.com/2021/day/11/input>_
//!
//! You enter a large cavern full of rare bioluminescent <a target="_blank" href="https://www.youtube.com/watch?v=eih-VSaS2g0">dumbo octopuses</a>! They seem to not like the Christmas lights on your submarine, so you turn them off for now.
//!
//! There are 100 <span title="I know it's weird; I grew up saying 'octopi' too.">octopuses</span> arranged neatly in a 10 by 10 grid. Each octopus slowly gains <em>energy</em> over time and <em>flashes</em> brightly for a moment when its energy is full. Although your lights are off, maybe you could navigate through the cave without disturbing the octopuses if you could predict when the flashes of light will happen.
//!
